      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="relative mb-14 text-center">
          ...
          <motion.h1
            ...
            animate="visible"
            custom={2}
            className="mb-4 font-serif text-3xl font-bold text-navy md:text-4xl lg:text-5xl"
          >
        ...
        {/* Two Column: Form + Stay Connected */}
        <div className="mb-16 grid gap-8 lg:grid-cols-5 lg:gap-10">
          {/* Left: Form Card */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="relative">
                  <User
                    size={16}
                    className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-navy/30"
                  />
                  <input
                    type="text"
                    name="name"
              ...
              <div className="relative">
                <MessageSquare
                  size={16}
                  className="pointer-events-none absolute left-3.5 top-4 text-navy/30"
                />
                <textarea
                  name="message"
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="mb-16 rounded-2xl border border-gold/10 bg-gradient-to-r from-gold/[0.03] via-cream to-gold/[0.03] p-6 shadow-soft md:p-8"
        >
          <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between">
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm leading-relaxed text-navy/70 md:text-base">
                ...
                <br />
                being a part of your transformation journey.
              </p>
            </div>

            <div className="flex items-center gap-3">
              <span className="font-serif text-3xl italic text-navy/60 md:text-4xl" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
                Abiya Benodson
              </span>
              <Leaf size={28} className="text-gold/50" />
            </div>
          </div>
        </motion.div>
      </div>
